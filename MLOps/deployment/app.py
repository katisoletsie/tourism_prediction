...
model_path = hf_hub_download(repo_id="katisoletsie/TourismPackagePrediction", filename="tourism_package_prediction_model.joblib")
...
if st.button("Predict"):
    ...
    result = "will likely purchase the travel package" if pred == 1 else "will likely not purchase the travel package"
